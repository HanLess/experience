...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse<Map<String,String>> pay(Long orderNo, Integer userId, String path) {
        ...
        List<OrderItem> orderItems = orderItemMapper.selectOrderItemByOrderNoUserId(orderNo,userId);
    ...
    public ServerResponse< String> queryPay(Integer userId, Long orderNo) {
        ...
        switch (status){
            case 10:
                return ServerResponse.createBySuccess(Const.OrderStatus.NO_PAY.getMsg());
            case 0:
                return ServerResponse.createBySuccess(Const.OrderStatus.CANCELED.getMsg());
            case 20:
                return ServerResponse.createBySuccess(Const.OrderStatus.PAID.getMsg());
            case 40:
                return ServerResponse.createBySuccess(Const.OrderStatus.SHIPPED.getMsg());
            case 50:
                return ServerResponse.createBySuccess(Const.OrderStatus.ORDER_SUCCESS.getMsg());
            case 60:
                return ServerResponse.createBySuccess(Const.OrderStatus.ORDER_CLOSE.getMsg());
        }
    ...
    private OrderVo assembleOrderVo(Order order,List<OrderItem> orderItemList){
        ...
        orderVo.setStatusDesc(Const.OrderStatus.codeOf(order.getStatus()).getMsg());
        orderVo.setShippingId(order.getShippingId());
        Shipping shipping = shippingMapper.selectByPrimaryKey(order.getShippingId());
        ShippingVo shippingVo = null;
        if(shipping != null){
            shippingVo = this.assembleShippingVo(shipping);
        }
